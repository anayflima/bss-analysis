...
def merge_trips_and_stations(trips, stations):
    ...
    # with_start = trips.merge(stations, how = 'left',
    #             left_on=['start_station_id'],
    #             right_on=['id'])
    
    # with_start_and_end = with_start.merge(stations, left_on='end_station_id', right_on='id', 
    #                                       suffixes=('_start', '_end'))
...
def merge_trips_stations_and_distances(trips_and_stations, stations_distances):
    ...
    # merge = trips_and_stations.merge(stations_distances, how = 'left',
    #                 left_on=['start_station_id', 'end_station_id'],
    #                 right_on=['id_source', 'id_destination'])
