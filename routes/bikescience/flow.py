...
def merge_trips_and_cells(trips, grid, stations, cell_identifier, cell_start_ids, cell_end_ids,
    ...
    grid_and_stations[station_index] = grid_and_stations[station_index].astype(int)

    print('grid_and_stations')
    display(grid_and_stations)

    print('od_station_counts')
    display(od_station_counts)
    ...
    print('with_origin_cells')
    display(with_origin_cells)
